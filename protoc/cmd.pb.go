...
func (x *ShellCmd) GetCommand() string {
	if x != nil {
		return x.Command
	}
	return ""
...
func (x *ShellExecReply) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ShellExecReply) ProtoMessage() {}

func (x *ShellExecReply) ProtoReflect() protoreflect.Message {
	mi := &file_cmd_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ShellExecReply.ProtoReflect.Descriptor instead.
func (*ShellExecReply) Descriptor() ([]byte, []int) {
	return file_cmd_proto_rawDescGZIP(), []int{1}
}

func (x *ShellExecReply) GetResult() string {
	if x != nil {
		return x.Result
	}
	return ""
...
var file_cmd_proto_rawDesc = []byte{
	0x0a, 0x09, 0x63, 0x6d, 0x64, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x24, 0x0a, 0x08, 0x53,
	0x68, 0x65, 0x6c, 0x6c, 0x43, 0x6d, 0x64, 0x12, 0x18, 0x0a, 0x07, 0x43, 0x6f, 0x6d, 0x6d, 0x61,
	0x6e, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x43, 0x6f, 0x6d, 0x6d, 0x61, 0x6e,
	0x64, 0x22, 0x28, 0x0a, 0x0e, 0x53, 0x68, 0x65, 0x6c, 0x6c, 0x45, 0x78, 0x65, 0x63, 0x52, 0x65,
	0x70, 0x6c, 0x79, 0x12, 0x16, 0x0a, 0x06, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x06, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x42, 0x15, 0x5a, 0x13, 0x2e,
	0x2e, 0x2f, 0x2e, 0x2e, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x63, 0x3b, 0x70, 0x72, 0x6f, 0x74,
...
var file_cmd_proto_goTypes = []interface{}{
	(*ShellCmd)(nil),       // 0: ShellCmd
	(*ShellExecReply)(nil), // 1: ShellExecReply
}
